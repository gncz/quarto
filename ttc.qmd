...
![Emperor Gordian III Aureus(coin), Assesed from Art Institute of Chicago via Public Domain Image](assets/gordian_coin.jpg)

## The hypothesis formulation

Our money, as a measure of value, should be able to help us make real world choices, even as the alternatives are expressed in nominal currency terms.
...
The root of the problem is, that our past decisions are irreversible, while the present value of past decisions fluctuate, according to the current money supply. 
...
```
\
A simple correlation between the two charts are apparent without any statistical device. To insert a fantastic quote. 
...
The brilliance of this is, that the essential value proposition of the product is effectively the same. By that I mean calories, nutrition and taste. This traverses time and space, which my simple diagrams also intend to achieve.
...
The chart on the rights points out that the Big Macs are could be considered undervalued.
If the sellers of the Big Macs product on the Hungarian market were to account entirely in dollars, should they raise prices to balance this. Luckily, this is has not been the case.
...
Over a 15 years timespan this is an equivalent of the 
`{python} round((1.52**(1/15) -1)*100,2)`% annual growth.
\
The bulk of this increase has happened between 2015 and 2020, as noted previously. After 2020 up until 2025 a period of income stagnation (measured in this product), with a visible price adjustment of 2022 likely to match the monetary expansion.
